...
const page = () => {
  ...
  return (
    <div className=' w-full '>
        ...
        <label>In Time</label>
        <input className=' bg-transparent border-2 rounded-3xl border-[#ffffff2b] p-2' name="in" type="datetime-local" placeholder='IN-time' />
        <label>Out Time</label>
        <input className=' bg-transparent border-2 rounded-3xl border-[#ffffff2b] p-2' name="out" type="datetime-local" placeholder='Out-time' />
        <label htmlFor="">Total hours</label>
        <input className=' bg-transparent border-2 rounded-3xl border-[#ffffff2b] p-2' name="total" type="number" placeholder='Total Hours' />
